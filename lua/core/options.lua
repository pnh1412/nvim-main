...
local options = {
	...
	writebackup = false, -- if another process is writing the file, avoid writebackup blocking edits
	...
	numberwidth = 5, -- set number column width
	signcolumn = "yes", -- always show the sign column, otherwise diagnostics shift text
	...
	lazyredraw = false, -- redraw while executing macros and commands
