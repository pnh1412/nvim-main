...
local global = {
	...
	border_enabled = false, -- NOTE: Toggle border for LSP Windows, lazy, which-key, mason
	mapleader = " ",
	maplocalleader = "\\",
	no_ide = vim.env.NVIM_NO_IDE ~= nil, -- set NVIM_NO_IDE=1 to skip LSP/format/lint for quick editing
